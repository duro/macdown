...
- (NSArray<NSString *> *)toolbarDefaultItemIdentifiers:(NSToolbar *)toolbar
{
    ...
    int spaceCount =
        (int)(sizeof(spaceAfterIndices) / sizeof(int));
    int flexibleSpaceCount =
    ...
    for (NSString *itemIdentifier in orderedToolbarItemIdentifiers)
    {
        ...
        // Bounds-check before indexing: reading past these C arrays is
        // undefined behavior and traps (SIGTRAP) under modern toolchains.
